                    ...
                    e.extend(t, {
                        ...
                        draw: function () {
                            ...
                            var l = [[i.base, n], [i.base, o], [r, o], [r, n]],
                                ...
                                d = h.indexOf(i.borderSkipped, 0); - 1 === d && (d = 0), e.moveTo.apply(e, t(0));
            ...
            i.doughnut = {
                ...
                legendCallback: function (t) {
                    ...
                    var i = t.data,
                        ...
                        o = i.labels;
                    if (a.length)
                        for (var n = 0; n < a[0].data.length; ++n) e.push('<li><span style="background-color:' + a[0].backgroundColor[n] + '"></span>'), o[n] && e.push(o[n]), e.push("</li>");
            ...
            t.defaults.polarArea = {
                ...
                legendCallback: function (t) {
                    ...
                    var i = t.data,
                        ...
                        o = i.labels;
                    if (a.length)
                        for (var n = 0; n < a[0].data.length; ++n) e.push('<li><span style="background-color:' + a[0].backgroundColor[n] + '">'), o[n] && e.push(o[n]), e.push("</span></li>");
                    return e.push("</ul>"), e.join("")
                },
                legend: {
                    labels: {
            ...
            t.DatasetController = function (t, e) {
                ...
                buildOrUpdateElements: function () {
                    ...
                    if (a > i) e.splice(i, a - i);
                        ...
                        for (var o = a; i > o; ++o) this.addElementAndReset(o)
                },
                update: i,
                draw: function (t) {
                    var i = t || 1;
            ...
            n.each = function (t, e, i, a) {
                ...
                return n.each(Array.prototype.slice.call(arguments, 1), function (e) {
                    n.each(e, function (e, a) {
                        if ("scales" === a) i[a] = n.scaleMerge(i.hasOwnProperty(a) ? i[a] : {}, e);
                        else if ("scale" === a) i[a] = n.configMerge(i.hasOwnProperty(a) ? i[a] : {}, t.scaleService.getScaleDefaults(e.type), e);
                        else if (i.hasOwnProperty(a) && n.isArray(i[a]) && n.isArray(e)) {
                            var o = i[a];
            ...
            t.defaults.global.legend = {
                ...
                handleEvent: function (t) {
                    var i = e.getRelativePosition(t, this.chart.chart),
                        ...
                        o = i.y,
                        n = this.options;
                    if (a >= this.left && a <= this.right && o >= this.top && o <= this.bottom)
                        for (var r = this.legendHitBoxes, s = 0; s < r.length; ++s) {
                            var l = r[s];
                ...
                draw: function (i) {
                    ...
                    if (a.display) {
                        ...
                        if (h.fillStyle = m, this.isHorizontal()) {
                            ...
                            if (n = !1, g && (F /= 2), (F + c.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) && (n = 1 + Math.floor((F + c.autoSkipPadding) * this.ticks.length / (this.width - (this.paddingLeft + this.paddingRight)))), l && this.ticks.length > l)
            ...
            t.Title = t.Element.extend({
                ...
                draw: function () {
                    var i = this,
                        ...
                        r = t.defaults.global;
                    if (n.display) {
                        var s, l, h = o(n.fontSize, r.defaultFontSize),
                    ...
                    if (!h.skip) {
                        ...
                        if (!(isNaN(u) || 0 >= u)) {
                            ...
                            case "triangle":
                                ...
                                o = 3 * u / Math.sqrt(3),
                                s = o * Math.sqrt(3) / 2,
                                d.moveTo(f - o / 2, g + s / 3),
                                d.lineTo(f + o / 2, g + s / 3),
                                d.lineTo(f, g - 2 * s / 3),
                                d.closePath(),
                                d.fill();
                                break;
                            ...
                            case "rectRot":
                                ...
                                d.rotate(Math.PI / 4),
                                l = 1 / Math.SQRT2 * u,
                                d.fillRect(-l, -l, 2 * l, 2 * l),
                                d.strokeRect(-l, -l, 2 * l, 2 * l),
                            ...
                            case "crossRot":
                                    d.beginPath(),
                                n = Math.cos(Math.PI / 4) * u,
                                r = Math.sin(Math.PI / 4) * u,
                                d.moveTo(f - n, g - r),
                                d.lineTo(f + n, g + r),
                                d.moveTo(f - n, g + r),
                                d.lineTo(f + n, g - r),
